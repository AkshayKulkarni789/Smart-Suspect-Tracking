...
__c3d_root__ = "F:/sem6/tarp/real world anomaly detection/C3D-master/C3D-v1.0/examples/c3d_feature_extraction/"
__batch_size__ = 20       
...
if __name__ == "__main__":
    ...
    total = preprocessing('F:/sem6/tarp/real world anomaly detection/dataset/UCF_Crimes/Videos/Abuse/', gpu)
